...
public class StudentController {
	...
	public @ResponseBody Student findById(@RequestParam Long id) throws StudentNotFoundExcepion {
		...
		//logger.info("Student before getting passport :{}",studentoOptional.get().getName());
		//logger.info("Student passport details  :{}",studentoOptional.get().getPassport());
		logger.info("Student before getting passport :{}",std.getName());
		logger.info("Student passport details  :{}",std.getPassport());
		
	//	logger.info("GSON  student :{}",gson.toJson(std));
	//	logger.info("GSON  student :{}",gson.toJson(std.getPassport()));
